...
fail=0
for needle in "Hello, World!" "Hello from the heap!" "heap self-check passed" "frame self-check passed" "mmu enabled" "mmu self-check passed" "exception vectors installed" "EXCEPTION (vector 4" "data abort (same EL)"; do
